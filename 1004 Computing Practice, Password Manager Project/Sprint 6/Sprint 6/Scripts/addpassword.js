...
// Function to show the add password modal
function showAddPasswordModal() {
    if (document.getElementById('addPasswordModal')) return;

    // Create a unique modal backdrop element
    const modalBackdrop = document.createElement('div');
    modalBackdrop.className = 'add-password-modal-backdrop';
    document.body.appendChild(modalBackdrop);

    // Prevent scrolling on the body with a unique class
    ...
    <div class="add-password-modal-content">
        ...
        <form id="addPasswordForm" class="add-password-form">
            ...
            <div class="form-group website-url-group">
                ...
                <input type="url" id="websiteURL" class="website-url-input" placeholder="Website URL">
            </div>
            ...
            <div class="form-group password-group">
                <div class="password-field">
                    ...
                    <input type="password" id="password" class="password-input" placeholder="Password" oninput="updatePasswordStrength(this.value)">
                    <button type="button" class="show-password-btn" onclick="toggleModalPasswordVisibility('password')">Show</button>
                </div>
    ...
    // Insert the modal HTML into the passwordFormDiv
...
function saveNewPassword(event) {
    ...
    // Function to generate the next ID for a new entry
